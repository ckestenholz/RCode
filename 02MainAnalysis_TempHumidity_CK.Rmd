...
rownames(res_TempHumidity) <- names(dlist)
 ...
 for (k in c(1,12,21,23,25)){
   ...
   FPCPP <- round(quantile(data$`partial pressure [hPa]`, 0.5, na.rm=T), digits=1)
   FPCRH <- round(quantile(data$`relative humidity [%]`, 0.5, na.rm=T), digits=1)
   ...
   res_TempHumidity[k,4] <-
     paste(round((cphumppnull[[k]]$RRfit[as.character(round(quantile(data$`partial pressure [hPa]`, 0.75, na.rm=T), digits=1))] - cphumppnull[[k]]$RRfit[as.character(round(quantile(data$`partial pressure [hPa]`, 0.25, na.rm=T), digits=1))]) / IQR(data$`partial pressure [hPa]`, na.rm=T), digits=5), " [", round((cphumppnull[[k]]$RRlow[as.character(round(quantile(data$`partial pressure [hPa]`, 0.75, na.rm=T), digits=1))] - cphumppnull[[k]]$RRlow[as.character(round(quantile(data$`partial pressure [hPa]`, 0.25, na.rm=T), digits=1))]) / IQR(data$`partial pressure [hPa]`, na.rm=T), digits=5), " - ", round((cphumppnull[[k]]$RRhigh[as.character(round(quantile(data$`partial pressure [hPa]`, 0.75, na.rm=T), digits=1))] - cphumppnull[[k]]$RRhigh[as.character(round(quantile(data$`partial pressure [hPa]`, 0.25, na.rm=T), digits=1))]) / IQR(data$`partial pressure [hPa]`, na.rm=T), digits=5), "] ")
    
   res_TempHumidity[k,5] <-
     paste(round((cphumppcomb[[k]]$RRfit[as.character(round(quantile(data$`partial pressure [hPa]`, 0.75, na.rm=T), digits=1))] - cphumppcomb[[k]]$RRfit[as.character(round(quantile(data$`partial pressure [hPa]`, 0.25, na.rm=T), digits=1))]) / IQR(data$`partial pressure [hPa]`, na.rm=T), digits=5), " [", round((cphumppcomb[[k]]$RRlow[as.character(round(quantile(data$`partial pressure [hPa]`, 0.75, na.rm=T), digits=1))] - cphumppcomb[[k]]$RRlow[as.character(round(quantile(data$`partial pressure [hPa]`, 0.25, na.rm=T), digits=1))]) / IQR(data$`partial pressure [hPa]`, na.rm=T), digits=5), " - ", round((cphumppcomb[[k]]$RRhigh[as.character(round(quantile(data$`partial pressure [hPa]`, 0.75, na.rm=T), digits=1))] - cphumppcomb[[k]]$RRhigh[as.character(round(quantile(data$`partial pressure [hPa]`, 0.25, na.rm=T), digits=1))]) / IQR(data$`partial pressure [hPa]`, na.rm=T), digits=5), "] ") 
   
   res_TempHumidity[k,6] <-
     paste(round((cphumrhnull[[k]]$RRfit[as.character(round(quantile(data$`relative humidity [%]`, 0.75, na.rm=T), digits=1))] - cphumrhnull[[k]]$RRfit[as.character(round(quantile(data$`relative humidity [%]`, 0.25, na.rm=T), digits=1))]) / IQR(data$`relative humidity [%]`, na.rm=T), digits=5), " [", round((cphumrhnull[[k]]$RRlow[as.character(round(quantile(data$`relative humidity [%]`, 0.75, na.rm=T), digits=1))] - cphumrhnull[[k]]$RRlow[as.character(round(quantile(data$`relative humidity [%]`, 0.25, na.rm=T), digits=1))]) / IQR(data$`relative humidity [%]`, na.rm=T), digits=5), " - ", round((cphumrhnull[[k]]$RRhigh[as.character(round(quantile(data$`relative humidity [%]`, 0.75, na.rm=T), digits=1))] - cphumrhnull[[k]]$RRhigh[as.character(round(quantile(data$`relative humidity [%]`, 0.25, na.rm=T), digits=1))]) / IQR(data$`relative humidity [%]`, na.rm=T), digits=5), "] ") 
   
   res_TempHumidity[k,7] <-
     paste(round((cphumrhcomb[[k]]$RRfit[as.character(round(quantile(data$`relative humidity [%]`, 0.75, na.rm=T), digits=1))] - cphumrhcomb[[k]]$RRfit[as.character(round(quantile(data$`relative humidity [%]`, 0.25, na.rm=T), digits=1))]) / IQR(data$`relative humidity [%]`, na.rm=T), digits=5), " [", round((cphumrhcomb[[k]]$RRlow[as.character(round(quantile(data$`relative humidity [%]`, 0.75, na.rm=T), digits=1))] - cphumrhcomb[[k]]$RRlow[as.character(round(quantile(data$`relative humidity [%]`, 0.25, na.rm=T), digits=1))]) / IQR(data$`relative humidity [%]`, na.rm=T), digits=5), " - ", round((cphumrhcomb[[k]]$RRhigh[as.character(round(quantile(data$`relative humidity [%]`, 0.75, na.rm=T), digits=1))] - cphumrhcomb[[k]]$RRhigh[as.character(round(quantile(data$`relative humidity [%]`, 0.25, na.rm=T), digits=1))]) / IQR(data$`relative humidity [%]`, na.rm=T), digits=5), "] ") 
